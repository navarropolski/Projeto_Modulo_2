...
$jogos = [
    ...
    [
        ...
        "url_steam" => "https://peaceful-cobbler-6780e6.netlify.app"
    ],
    [
        "id" => "snakehungry",
        "img" => "imagens\snakelogo.jpeg",
        "url" => "/jogo/snakehungry/",
        "descricao" => "O clássico jogo SNAKE, aonde seu principal objetivo é comer maçãs para aumentar seu tamanho e ficar cada vez mais rápido, dando uma dinâmica única, sensacional e muito clássica.",
        "url_steam" => "https://jpaulo-stk.github.io/Snake-Hungry/jogo.html"
    ],
    [
        "id" => "deeprockgalactic",
        "img" => "imagens\deeprock.jpg",
        "url" => "/jogo/deeprockgalactic/",
        ...
        "url_steam" => "https://store.steampowered.com/app/548430/Deep_Rock_Galactic/"
    ],
    [
        "id" => "eldenring",
        "img" => "imagens\_eldenring.jpg",
        "url" => "/jogo/eldenring/",
    ...
    [
        "id" => "counterstrike2",
        "img" => "imagens\counterstrike2.jpg",
        "url" => "/jogo/counterstrike2/",
        ...
        "url_steam" => "https://store.steampowered.com/app/730/CounterStrike_2/"
    ],
    [
        "id" => "dota2",
        "img" => "imagens\dota.jpg",
        "url" => "/jogo/dota2/",
        "descricao" => "Diariamente, milhões de jogadores mundo afora batalham como um dentre os mais de cem heróis do Dota. Estejam jogando há 10 ou 1.000 horas, há sempre algo novo para descobrir. Com atualizações constantes das mecânicas, recursos e heróis, o Dota 2 se tornou mais que um simples jogo.",
        "url_steam" => "https://store.steampowered.com/app/570/Dota_2/"
    ],
    [
        "id" => "dayz",
        "img" => "imagens\dayz.jpg",
        "url" => "/jogo/dayz/",
        ...
        "url_steam" => "https://store.steampowered.com/app/221100/DayZ/"
    ],
    [
        "id" => "shadowofwar",
        "img" => "imagens\shadowofwar.jpg",
        "url" => "/jogo/shadowofwar/",
        "descricao" => "Viva a experiência de um mundo aberto épico, trazido à vida pelo premiado Sistema Nêmesis. Forje um novo Anel do Poder, conquiste Fortalezas em batalhas gigantescas e domine Mordor com seu próprio exército de orcs em Terra-média™: Sombras da Guerra™.",
        "url_steam" => "https://store.steampowered.com/app/356190/Middleearth_Shadow_of_War/"
    ],
    [
        "id" => "ageofempires2",
        "img" => "imagens\ageofempires.jpg",
        "url" => "/jogo/shadowofwar/",
        "descricao" => "Age of Empires II: Definitive Edition apresenta 'Os Últimos Khans', com 3 novas campanhas e 4 novas Civilizações. Atualizações frequentes incluem eventos, conteúdo adicional, novos modos de jogo e recursos aprimorados com a recente adição do modo Coop!",
        "url_steam" => "https://store.steampowered.com/app/813780/Age_of_Empires_II_Definitive_Edition/"
    ],
    [
        "id" => "heartsofiron4",
        "img" => "imagens\hoi4.jpg",
        "url" => "/jogo/heartsofiron4",
        "descricao" => "A vitória está ao alcance de seus dedos! Sua habilidade de liderar sua nação é sua arma suprema, o jogo de estratégia Hearts of Iron IV permite que você comande qualquer nação na Segunda Guerra Mundial, o conflito mais intenso da história do mundo.",
        "url_steam" => "https://store.steampowered.com/app/394360/Hearts_of_Iron_IV/"
    ],
    [
        "id" => "rust",
        "img" => "imagens\_rust.jpg",
        "url" => "/jogo/rust",
        "descricao" => "O único objetivo em Rust é sobreviver. Tudo quer que você morra - a vida selvagem da ilha e outros habitantes, o meio ambiente, outros sobreviventes. Faça o que for preciso para durar mais uma noite.",
        "url_steam" => "https://store.steampowered.com/app/252490/Rust/"
    ],
];
